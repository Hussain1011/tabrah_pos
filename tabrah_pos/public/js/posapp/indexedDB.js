...
const indexedDBService = {
  ...
  */
  ...
  /*
    ...
    PARAMS: (Object: Response from pos.pos.api.posapp.get_items_groups API call)
    Returns: None
 */
    saveItemGroups(data) {
      try {
  ...
  /*
    ...
    PARAMS: (Object: Response from pos.pos.api.posapp.get_Table_names API call)
    Returns: None
  */
  saveTableInfo(data) {
  ...
  */
  ...
  /*
    ...
    PARAMS: (Object: Response from pos.pos.api.posapp.get_Order_type API call)
    Returns: None
  */
  saveOrderType(data) {

    ...
    <v-card class="payment-card py-4 px-8">
      ...
      <v-row class="pt-0 mt-0">
        <v-col cols="2" class="pt-0">
          <div class="amount-div paid-div">
            ...
            <p class="amount-pay">
              Rs. {{ parseFloat(totalPaidAmount).toFixed(2) || 0.0 }}
            </p>
          </div>
        </v-col>
        <v-col cols="2" class="pt-0">
          <div class="amount-div to-paid-div">
            ...
            <p class="amount-pay">
              Rs. {{ parseFloat(invoice_doc.grand_total).toFixed(2) }}
            </p>
          </div>
        </v-col>
        <v-col cols="3" class="pt-0">
          <div class="amount-div to-paid-div">
            ...
            <p class="amount-pay">
              Rs. {{ parseFloat(invoice_doc.remaining_amount || 0).toFixed(1) }}
            </p>
          </div>
        </v-col>
        <v-col cols="2" class="pt-0">
      ...
      <v-row class="my-4">
        ...
        <v-col cols="2">
          ...
          <div class="grey--text amount-pay pt-2">
            Rs. {{ parseFloat(invoice_doc.net_total).toFixed(2) }}
          </div>
          <v-divider
            :thickness="2"
            class="border-opacity-75"
        ...
        <v-col cols="2">
          ...
          <div class="grey--text amount-pay pt-2">
            Rs.{{ parseFloat(invoice_doc.discount_amount).toFixed(2) }}
          </div>
          <v-divider
            :thickness="2"
            class="border-opacity-75"

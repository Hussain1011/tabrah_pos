...
export default {
  ...
  methods: {
    ...
    update_invoice_from_order(doc) {
      const vm = this;
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.update_invoice_from_order",
        args: {
          data: doc,
        },
        async: false,
    ...
    async show_payment() {
      ...
      if (this.invoice_doc.doctype == "Sales Order") {
        ...
        frappe.call({
          method:
            "tabrah_pos.tabrah_pos.api.posapp.get_sales_invoice_child_table",
          args: {
    ...
    get_draft_invoices() {
      const vm = this;
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.get_draft_invoices",
        args: {
    ...
    update_items_details(items) {
      ...
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.get_items_details",
        async: false,
        args: {
    ...
    update_item_detail(item) {
      ...
      const vm = this;
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.get_item_detail",
        args: {

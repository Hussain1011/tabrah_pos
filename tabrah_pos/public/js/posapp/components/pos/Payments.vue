...
export default {
  ...
  methods: {
    ...
    get_available_credit(e) {
      ...
      if (e) {
        frappe
          .call("tabrah_pos.tabrah_pos.api.posapp.get_available_credit", {
    ...
    get_addresses() {
      ...
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.get_customer_addresses",
    ...
    get_sales_person_names() {
      ...
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.posapp.get_sales_person_names",
        callback: function (r) {
          if (r.message) {
    ...
    request_payment() {
      ...
      frappe
        ...
        .then(() => {
          frappe
            .call({
              method: "tabrah_pos.tabrah_pos.api.posapp.create_payment_request",
              args: {
                doc: vm.invoice_doc,
              },
            })
    ...
    get_mpesa_modes() {
      const vm = this;
      frappe.call({
        method: "tabrah_pos.tabrah_pos.api.m_pesa.get_mpesa_mode_of_payment",
